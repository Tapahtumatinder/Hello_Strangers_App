...
const EventMap = (props) => {
    ...
    const getCoordinates = (events) => {
        if (eventsWithCoords.length > events.length) {
            setEventsWithCoords([]);
        }
    ...
    /* getting coordinates for all events when loading the component */
    useEffect(() => {
    ...
    //* return mapview with custom-markers and zoom-buttons
    return (
