...
const EventScreen = () => {
  ...
  // TODO: add tags and cover image, validation, input fields UI (size etc)...
  ...
  const dateToString = (fullDate) => {
    if (fullDate) return fullDate.getDate() + '.' + (fullDate.getMonth() + 1) + '.' + fullDate.getFullYear();
  }
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView
        ...
        <Input
          ...
          value={dateToString(startDateTime)}
        ...
        <Input
          label='END DATE'
          placeholder='Set date'
          value={dateToString(endDateTime)}
        ...
        <Input
          ...
          value={endDateTime.toTimeString().substring(0, 5)}
