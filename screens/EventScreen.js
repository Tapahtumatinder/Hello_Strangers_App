...
import { addDoc, collection, doc, setDoc, getDoc, getDocs, query } from 'firebase/firestore/lite';
...
const EventScreen = ({ navigation }) => {
  ...
  // TODO: tags and cover image, validation...
  ...
  const getAllTags = async () => {
    ...
    try {
      ...
      querySnapshot.forEach((doc) => {
        tempTag = doc.data();
        tempTag['id'] = doc.id;
        tempTagsList.push(tempTag);
      });
      console.log(tempTagsList)
      setAllTags(tempTagsList);
